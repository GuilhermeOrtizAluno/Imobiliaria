...
<table class="table table-striped">
    ...
    <tbody>
        <?php foreach($immovables as $immovable) : ?>
            <tr>
                <th class="text-center"><?= $immovable->reference ?></th>
                <th class="text-center"><?= $immovable->type ?></th>
                <th class="text-center"><?= $immovable->value ?></th>
                <th class="text-center"><?= $immovable->city ?></th>
                <th class="text-center"><?= $immovable->district ?></th>
