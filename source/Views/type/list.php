...
<table class="table table-striped">
    ...
    <tbody>
        <?php foreach($types as $type) : ?>
            <tr>
                <th class="text-center"><?= $type->descricao ?></th>
                <th class="text-center"><?= $type->created_at ?></th>
                <th class="text-center"><?= $type->updated_at ?></th>
                <td class="text-center">
                    <button class="btn btn-danger" data-toggle="modal" data-target="#delete" onclick="idDel(<?= $type->id ?>)">
